<template>
  <div data-hash="result" class="app-wrapper">
    <div class="app-container">
      <div class="app-body">
        <h2 class="title">Your appoximate blood oxygen level is</h2>
      ...
      <div class="app-footer">
        <div class="text-card t-sm">
          ...
          diagnose the exact spO2 value. the test can only indentify patients at
          risk of severe shortness of breath. The most accurate way to measure
          spO2 is to buy a pulse oximeter or Apple Watch s6.
        </div>
        <a class="footer-btn-lite" href="#">Try again</a>
