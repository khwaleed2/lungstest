    ...
    <div class="app-container">
      <div class="app-body flex-center">
        <h3 class="title min-h-105">
          ...
          <transition name="fade">
            <span
              v-if="inhale && inhaleComplete === false && holdBreath === false"
            >
              Take a slow, <br />
              deep breath
            </span>
        ...
        >
          ...
          <span v-if="start === true && inhale === false" class="count-dwon">{{
            countDown
          }}</span>
        ...
        <transition name="fade">
          <div v-if="holdBreath === true" class="hold-breath-counter">
            <button @click="stopTiming" v-if="done === false" class="stop-btn">
            ...
            >
              <g id="circle">
                <circle id="line" cx="112" cy="112" r="94.5" stroke="white" />
                <g id="circle_2" filter="url(#filter0_d)">
                  <circle
                    cx="111.5"
                    cy="111.5"
                    r="94.5"
                    :style="`animation-duration: ${holdBreathDuration}s; animation-delay: ${1}s;`"
                    stroke="white"
                    stroke-width="8"
                  />
                </g>
